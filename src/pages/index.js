// СЕРГЕЙ, СПАСИБО, ЧТО ПОКАЗАЛИ, КАК СОЗДАТЬ МЕТОД ОБРАБОТЧИКА КНОПКИ ПОПАПА!!! Я ВСЮ ГОЛОВУ СЛОМАЛ - КАК ПРОБРОСИТЬ ХЕНДЛЕР, В КОТОРОМ ЕСТЬ ЭКЗЕМПЛЯР КЛАССА Api.
